...
* query the entire graph to build a tree-control to present IT skills and technologies in a UI (for example: [this](https://struct-ure.github.io/kg/examples/ui-tree/))
